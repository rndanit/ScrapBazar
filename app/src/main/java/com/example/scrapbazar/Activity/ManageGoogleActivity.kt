...
import com.example.scrapbazar.databinding.ActivityManageGoogleBinding
...
class ManageGoogleActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var binding: ActivityManageGoogleBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityManageGoogleBinding.inflate(layoutInflater)
        ...
        MapButton = findViewById(R.id.addAddressbutton)
        ...
        MapButton.setOnClickListener {
            ...
            if (otpId != -1) {
                ...
                val intent =
                    Intent(this@ManageGoogleActivity, ManageAddressActivity::class.java)
            ...
            editText.addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable?) {
                    ...
                    val drawable: Drawable? = if (input.length > 0) {
                        ContextCompat.getDrawable(this@ManageGoogleActivity, R.drawable.green_right)
                    } else {
                        ContextCompat.getDrawable(this@ManageGoogleActivity, R.drawable.right)
                    }
